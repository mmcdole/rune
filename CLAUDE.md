...
- Input processing follows the canonical [Submission lifecycle](docs/architecture.md#submission-lifecycle). Session owns sequencing, cancellation, history snapshots, and the cumulative execution budget; Engine owns one-line Lua calls and their result contracts.
