...
Server Partial Line -> net output -> Session -> rune.hooks.call("prompt", line, false) -> prompt overlay
Server GA/EOR Prompt -> net output -> Session -> rune.hooks.call("prompt", line, true) -> UI prompt overlay
Game Line -> network writer -> OutputSendBoundary -> Session commits prompt overlay / flushes spans
